...
export default function PP() {
  ...
  return (
    <div className="p-4">
      ...
      <P>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <ExtLink href="https://www.privacypolicies.com/privacy-policy-generator/">Privacy Policy Generator</ExtLink>.</P>
      <BR/>
      <BR/>
      ...
      <ul>
        ...
        <li>
          <P><strong>Application</strong> refers to Donglotin, the software program provided by the Company.</P>
        </li>
        <li>
          <P><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Donglotin.</P>
        </li>
        <li>
      ...
      <ul>
        <li>By email: <span className="select-none pointer-events-none">rzfury90@gmail.com</span></li>
      </ul>
    </div>
  )
}
